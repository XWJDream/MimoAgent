...
| TTS 存储 | `tts-store.test.ts` | 8 |
| IPC 处理 | `ipc.test.ts` | 16 |
| Agent 服务 | `agent-service.test.ts` | 9 |
| 聊天状态 | `chatStore.test.ts` | 16 |
| 输入区域 | `InputArea.test.tsx` | 10 |
| 消息气泡 | `MessageBubble.test.tsx` | 12 |
